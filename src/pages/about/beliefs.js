      ...
      <Container width={['100%', '80%']} mx="auto">
        <Flex flexDirection="column">
          ...
          <Box my="1rem">
            ...
            <Text>
              We believe there is one God. In the unity of the Godhead, there
              are three persons, Father, Son, and Holy Spirit, equal in every
              divine perfection and attribute, fulfilling distinct but
              complementary roles in the great work of redemption.
            </Text>
          </Box>
          <Box my="1rem">
          ...
          <Box my="1rem">
            ...
            <Text>
              We believe every Christian should walk and abide in daily
              fellowship with the Holy Spirit and experience continual renewing
              of God’s power to live a Spirit-filled life in attitudes,
          ...
          <Box my="1rem">
            ...
            <Text>
              We believe the Great Commission of our Lord Jesus Christ commands
              us to carry the gospel message to the entire world – to every
              nation, ethnicity, culture, and language. The growth and strength
              of the Church depend on its wholehearted sacrifice and support for
          ...
          <Box my="1rem">
            ...
            <Text>
              ...
              & learning His Word. We will give our time, spiritual gifts,
              abilities and finances to extend Christ’s Kingdom.
            </Text>
          </Box>
          <Box my="1rem">
            <Heading fontSize={3}>Lead People into Commitment</Heading>
            <Text>
              We are on a journey of faith together. We depend on the
              transforming power of God in our lives. We desire to disciple and
              raise up leaders who are followers of Jesus and obey His
              teachings.
            </Text>
          </Box>
          <Box my="1rem">
            ...
            <Text>
              We grow in relationship with God by being in relationship with
              God’s people. We invest in the lives of others by building Christ
              centered relationships, and creating a culture of teamwork where
